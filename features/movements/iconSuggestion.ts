...
const ICON_RULES: IconRule[] = [
  { keywords: ['supermercado', 'super', 'feria', 'almacen', 'verduleria'], icon: 'cart-outline' },
  { keywords: ['restaurante', 'resto', 'almuerzo', 'cena', 'comida', 'delivery', 'rappi', 'pedidosya'], icon: 'restaurant-outline' },
  { keywords: ['bencina', 'combustible', 'uber', 'taxi', 'cabify', 'didi', 'estacionamiento', 'peaje', 'auto'], icon: 'car-outline' },
  ...
  { keywords: ['celular', 'telefono', 'entel', 'claro', 'movistar', 'plan'], icon: 'call-outline' },
  { keywords: ['farmacia', 'doctor', 'medico', 'clinica', 'salud', 'dental', 'isapre'], icon: 'medical-outline' },
  ...
  { keywords: ['peluqueria', 'barberia', 'manicure', 'corte de pelo'], icon: 'cut-outline' },
