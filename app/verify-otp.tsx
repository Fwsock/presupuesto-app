...
import { resendSignupOtp, translateAuthError, verifySignupOtp } from '../features/auth/hooks';
...
export default function VerifyOtpScreen() {
  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      // guards (app/_layout.tsx) react to the new session automatically,
      // same convention as login.tsx/register.tsx.
    } catch (err) {
  ...
  // Auto-submit the moment the 6th digit lands, so "Continuar" is a fallback
  // for anyone who typed it in some other way, not the only path.
  useEffect(() => {
